        ...
        <div className="max-w-7xl mx-auto">
          ...
          <motion.div className="text-center mb-20" variants={itemVariants}>
            ...
            >
              ...
              <motion.div
                className="absolute -top-4 -right-4 w-8 h-8 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-full blur-sm"
                animate={{
                  scale: [1, 1.5, 1],
                  opacity: [0.5, 1, 0.5],
                }}
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <motion.div className="space-y-12" variants={itemVariants}>
              ...
              <motion.div
                ...
                whileHover="hover"
              >
                <div className="absolute inset-0 bg-gradient-to-r from-cyan-500/20 to-purple-500/20 rounded-3xl blur-xl group-hover:blur-2xl transition-all duration-300" />
                <div className="relative bg-slate-800/50 backdrop-blur-sm border border-cyan-500/30 rounded-3xl p-8 hover:border-cyan-400/50 transition-all duration-300">
                  <div className="flex items-center space-x-6 mb-6">
                   
                  <motion.div className="w-32 h-32 bg-gradient-to-r from-cyan-400 to-purple-400 rounded-2xl flex items-center justify-center overflow-hidden shadow-xl">
                    <img 
                      src={profileImg}
                      alt="Your Profile" 
                    ...
                    />
                    <div className="w-full h-full bg-gradient-to-r from-cyan-400 to-purple-400 flex items-center justify-center text-3xl font-bold text-white" style={{display: 'none'}}>
                      EZ
                    </div>
                  </motion.div>
                    ...
                    <div>
                      <h3 className="text-2xl font-bold text-white mb-1">Efengsi Rahmanto Zalukhu</h3>
                      <p className="text-cyan-400 font-medium">Backend Developer</p>
                    </div>
                  </div>
              ...
              <motion.div variants={itemVariants}>
                <h3 className="text-2xl font-bold text-white mb-6 text-center lg:text-left">Technical Expertise</h3>
                <div className="grid grid-cols-2 gap-4">
                  {skills.map((skill, index) => (
                    <motion.div
                      key={skill.name}
                      className={`group relative bg-gradient-to-r ${skill.color} border border-cyan-500/20 rounded-xl p-4 hover:border-cyan-400/50 transition-all duration-300 cursor-pointer`}
                      variants={cardVariants}
                      custom={index}
                      whileHover="hover"
                    >
                      <div className="flex items-center space-x-3">
                        ...
                        <span className={`font-medium ${skill.text}`}>{skill.name}</span>
                      </div>
            ...
            <motion.div className="space-y-12" variants={itemVariants}>
              ...
              <motion.div className="grid grid-cols-2 gap-6" variants={itemVariants}>
                {achievements.map((achievement, index) => (
                  <motion.div
                    ...
                    className="group relative bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-2xl p-6 hover:border-purple-400/50 transition-all duration-300"
                    variants={cardVariants}
                    custom={index}
                    whileHover="hover"
                  >
                    ...
                    <div className="relative text-center">
                      <motion.div
                        className="text-3xl font-black bg-gradient-to-r from-cyan-400 to-purple-400 bg-clip-text text-transparent mb-2"
                        initial={{ scale: 0 }}
                        animate={{ scale: 1 }}
              ...
              >
                ...
                <div className="relative bg-slate-800/50 backdrop-blur-sm border border-purple-500/30 rounded-3xl p-8 hover:border-purple-400/50 transition-all duration-300">
                  <motion.div className="text-6xl text-purple-400/50 mb-4">❝</motion.div>
                  ...
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="text-white font-medium">Efengsi Rahmanto Zalukhu</p>
              ...
              >
                <motion.button
                  className="group relative bg-gradient-to-r from-cyan-500 to-purple-500 px-8 py-4 rounded-full font-bold text-white shadow-2xl hover:shadow-cyan-500/50 transition-all duration-300"
