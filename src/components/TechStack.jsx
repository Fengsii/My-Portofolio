...
const techs = [
  ...
  { icon: <div className="w-12 h-12 flex items-center justify-center font-bold text-lg">C#</div>, name: "C#", color: "#239120" },
  { icon: <div className="w-12 h-12 flex items-center justify-center font-bold text-sm">.NET</div>, name: ".NET", color: "#512BD4" },
